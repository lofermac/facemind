...
export default function ProfissionaisLoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-green-600 to-teal-500 justify-center items-center p-12">
        <div className="text-white space-y-6 max-w-lg">
          <h1 className="text-4xl font-bold">FaceMind Profissionais</h1>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleLogin} className="mt-8 space-y-6">
            ...
            <div>
              <button
                type="submit"
                className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-300 ease-in-out transform hover:scale-[1.02]"
              >
                Entrar
              </button>
            </div>
