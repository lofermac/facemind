      ...
      <div className="flow-root">
        <ul role="list" className="space-y-3 max-h-72 overflow-y-auto">
          ...
          {aniversariantes.length === 0 && (
            <li className="flex min-h-[200px] items-center justify-center text-center flex-col">
              <span className="text-4xl" role="img" aria-label="presente">🎁</span>
              <p className="mt-3 text-sm text-slate-500 italic">Sem aniversariantes este mês.</p>
            </li>
          )}
        </ul>
      </div>
